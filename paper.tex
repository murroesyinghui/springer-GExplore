...
\stitle{Keyword Graph Queries} \dnote{DAVIDE: To add} 
...
\stitle{Refinement of Graph Query Results} is needed to deal with the overwhelming amount of results that is typical in subgraph processing. It includes approaches designed to present comprehensive result sets to the user or intermediate results that can be refined further. Instantiations of this kind are graph summaries, top-k methods, query reformulation, and skyline queries. 
