...
%\dnote{WHERE? Why-not on graphs\citep{islam2015efficient}}



% Given query results, and additional missing graphs, how to find the minimal query as close as possible to Q efficiently. Use a distance among queries. 
